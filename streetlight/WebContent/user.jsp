...
<body>
   ...
   <div class="container">
       ...
       <div class="login-container">
        <div id="first">
<form action="user/userlogin.jsp" method="post">
    <h2>User Login</h2>
    <div class="input-div one ">
          ...
          <div>
          <input type="text" class="input" name="uemail" placeholder="Username">
          </div>
    </div>
    ...
    <div class="input-div two " >
     ...
     <input type="submit" class="btn" value="Login">
         <div class="form-group">
                <p class="text-center"><a href="admin.jsp" id="signin">Admin</a></p>
         </div>
</form>
