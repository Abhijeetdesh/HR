              ...
              %>
               <tr>
                 ...
                 <td><%= rs.getString("admin_phone") %></td>
                  <td><a href="editOne.jsp?dpid=<%=rs.getString("dpid")%>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a></td>                
                  <td><a href="delete_record1.jsp?dpid=<%=rs.getString("dpid")%>"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></a></td>           
